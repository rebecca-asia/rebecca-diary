...
│   ├── diary.html      # Diary page (generated by SSG)
│   ├── nurture-prototype.html # Status Screen — HUD/サイバーパンク育成ダッシュボード
...
│   └── assets/
│       └── rebecca/
│           ├── anime icon.jpeg  # Character icon (used in app.js, HTML)
│           ├── transparent/     # Character sprites (expressions)
│           └── reference/       # Reference images (not used in code)
├── docs/               # Project docs (see docs/README.md for index)
│   ├── README.md       # Documentation index
│   ├── PLANNING.md     # Roadmap (Phase 0-5)
│   ├── ADR.md          # Architecture decision records
│   ├── ROOM_OVERVIEW.md # Product overview
...
See `docs/design/RULES.md` for full design system (**authoritative source**). Key variables:
...
- **Design authority:** `docs/design/RULES.md` is the single source of truth for CSS
...
| File | Purpose |
|------|---------|
| `scripts/update_diary.py` | 日記生成スクリプト（SSGコア） |
| `scripts/watch_diary.py` | リアルタイム監視デーモン |
